...
import com.hb.map.navigation.BuildConfig;
import com.hb.map.navigation.v1.exception.NavigationException;
...
import com.hb.map.navigation.v1.navigation.metrics.RerouteEvent;
import com.hb.map.navigation.v1.navigation.metrics.SessionState;
import com.hb.map.navigation.v1.navigation.metrics.TelemetryEvent;
...
import com.hb.map.navigation.v1.utils.RingBuffer;
...
class NavigationTelemetry implements NavigationMetricListener {
    ...
    private static final String MOCK_PROVIDER = "com.hb.map.navigation.v1.location.replay"
    ...
    private List<Location> createLocationListBeforeEvent(Date eventDate) {
        ...
        Location[] currentLocationList = locations;

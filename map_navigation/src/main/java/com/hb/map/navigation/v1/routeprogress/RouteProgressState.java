...
public enum RouteProgressState {
    ...
    /**
     * The {@link DirectionsRoute} provided
     * via {@link com.hb.map.navigation.v1.navigation.MapboxNavigation#startNavigation(DirectionsRoute)}
     * is not valid.
     */
    ROUTE_INVALID,
     ...
     * and {@link com.hb.map.navigation.v1.navigation.MapboxNavigation} is waiting for
    ...
    /**
     * {@link com.hb.map.navigation.v1.navigation.MapboxNavigation} is now confidently tracking the

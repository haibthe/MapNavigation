...
import com.hb.map.navigation.v1.routeprogress.RouteStepProgress;
...
import static com.hb.map.navigation.v1.navigation.NavigationConstants.NAVIGATION_CHECK_FASTER_ROUTE_INTERVAL;
import static com.hb.map.navigation.v1.navigation.NavigationConstants.NAVIGATION_MEDIUM_ALERT_DURATION;
...
public class FasterRouteDetector extends FasterRoute {
    ...
    public boolean isFasterRoute(DirectionsResponse response, RouteProgress routeProgress) {
        if (validRouteResponse(response)) {
            ...
            return newRoute.duration() <= (0.9 * currentDurationRemaining);
        }
        return false;
    }
     ...
     * {@link com.hb.map.navigation.v1.navigation.NavigationConstants#NAVIGATION_MEDIUM_ALERT_DURATION}.
     *
